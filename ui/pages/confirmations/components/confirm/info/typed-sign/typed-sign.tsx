...
import { isSnapId } from '@aleksapp/snaps-utils';
...
const TypedSignInfo: React.FC = () => {
  ...
  if (!currentConfirmation?.msgParams) return null;
  ...
  const decimalsNumber =
    tokenContract ? useGetTokenStandardAndDetails(tokenContract).decimalsNumber : undefined;
